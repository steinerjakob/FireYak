...
export const satelliteFlavor: Flavor = {
	...
	roads_label_minor_halo: 'rgba(0, 0, 0, 0.85)',
	roads_label_major: '#ffffff',
	roads_label_major_halo: 'rgba(0, 0, 0, 0.85)',
	ocean_label: '#a0d4ff',
	subplace_label: '#ffffff',
	subplace_label_halo: 'rgba(0, 0, 0, 0.85)',
	city_label: '#ffffff',
	city_label_halo: 'rgba(0, 0, 0, 0.85)',
	state_label: '#e0e0e0',
	state_label_halo: 'rgba(0, 0, 0, 0.85)',
	country_label: '#ffffff',
	address_label: '#e0e0e0',
	address_label_halo: 'rgba(0, 0, 0, 0.85)',
